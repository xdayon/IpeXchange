...
const NOTIFICATIONS = [
  ...
  { id: 'n5', type: 'msg',     unread: false, time: '4h',  icon: MessageCircle, color: '#38BDF8', title: 'Message from Xchange Core', desc: 'Detected plumbing services available today in Ipê City — you had an active search.' },
